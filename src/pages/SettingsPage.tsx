...
import { Settings, Bell, Shield, Wallet, Moon, Sun, Globe, Save, Download, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="font-inter font-bold text-xl text-gray-900">Privacy & Data</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-inter font-medium text-gray-900">Your Data</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button 
                    ...
                    className="flex items-center justify-center space-x-2 px-4 py-2 bg-green-600 text-white rounded-lg font-inter font-medium hover:bg-green-700 transition-colors duration-200"
                  >
                  ...
                  <button 
                    ...
                    className="flex items-center justify-center space-x-2 px-4 py-2 bg-red-600 text-white rounded-lg font-inter font-medium hover:bg-red-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
