    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-12 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
            ...
            return (
              <div key={index} className="group relative">
                ...
                <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                  ...
                  <h3 className="font-inter font-bold text-2xl text-white mb-1">
                    {stat.value}
                  </h3>
          ...
          <div className={`group relative transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-inter font-bold text-xl text-white flex items-center gap-2">
              ...
              <div className="space-y-4">
                {recentActivity.map((activity, index) => (
                  <div key={index} className="group/item flex items-start space-x-3 p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="flex-1">
                      <p className="font-inter text-white font-medium">{activity.action}</p>
                      <p className="font-inter text-gray-300 text-sm">{activity.event}</p>
            ...
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
              ...
              <div className="space-y-4">
                {topEvents.map((event, index) => (
                  <div key={index} className="group/item flex items-center justify-between p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 hover:scale-[1.02]">
                    <div className="flex-1">
                      <p className="font-inter text-white font-medium">{event.name}</p>
                      <p className="font-inter text-gray-400 text-sm">{event.totalRatings} ratings</p>
                    </div>
                    <div className="text-right">
                      <div className="flex items-center space-x-1">
                        <span className="font-inter font-bold text-white">{event.rating}</span>
        ...
        <div className={`group relative mt-8 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
            <h2 className="font-inter font-bold text-xl text-white mb-6 flex items-center gap-2">
              <Sparkles className="w-6 h-6 text-green-400" />
              Community Guidelines
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-inter font-semibold text-white mb-3">Rating Guidelines</h3>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2 group/guideline hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="font-inter text-gray-300">Be honest and constructive in your feedback</span>
                  </li>
                  <li className="flex items-start space-x-2 group/guideline hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="font-inter text-gray-300">Rate based on your actual experience</span>
                  </li>
                  <li className="flex items-start space-x-2 group/guideline hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="font-inter text-gray-300">Respect the anonymity of the platform</span>
                  </li>
                </ul>
              </div>
              
              <div>
                <h3 className="font-inter font-semibold text-white mb-3">Community Values</h3>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2 group/value hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="font-inter text-gray-300">Transparency and honesty</span>
                  </li>
                  <li className="flex items-start space-x-2 group/value hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="font-inter text-gray-300">Constructive feedback</span>
                  </li>
                  <li className="flex items-start space-x-2 group/value hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="font-inter text-gray-300">Respect for all participants</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className={`relative mt-8 transition-all duration-1000 delay-1100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative bg-gradient-to-r from-blue-500/20 to-purple-600/20 backdrop-blur-lg border border-white/30 rounded-2xl p-8 text-center hover:scale-[1.02] transition-transform duration-300">
