        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className={`mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <p className="font-inter text-2xl text-gray-300 mb-4 max-w-3xl mx-auto leading-relaxed">
              ...
              <p className="font-inter text-lg text-gray-400 max-w-xl mx-auto flex items-center justify-center gap-2">
          ...
          <div className={`grid md:grid-cols-3 gap-8 mb-16 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 className="font-inter font-bold text-xl text-white mb-3">Instant Rating</h3>
                <p className="font-inter text-gray-300 leading-relaxed">Submit ratings quickly and anonymously with blockchain verification</p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 className="font-inter font-bold text-xl text-white mb-3">Blockchain Verified</h3>
                <p className="font-inter text-gray-300 leading-relaxed">Permanently recorded on Algorand for complete transparency</p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 className="font-inter font-bold text-xl text-white mb-3">Real-time Analytics</h3>
                <p className="font-inter text-gray-300 leading-relaxed">View comprehensive statistics and trends in real-time</p>
              </div>
            </div>
          </div>
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <Link 
              to="/feedback"
              className="group relative px-10 py-4 bg-white/10 backdrop-blur-lg border border-white/30 text-white rounded-xl font-inter font-semibold hover:bg-white/20 transition-all duration-300 min-w-[200px] overflow-hidden"
            >
          ...
          <div className={`mt-20 grid md:grid-cols-3 gap-8 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="text-center group">
              ...
              <div className="text-gray-400 font-inter">Active Users</div>
            </div>
            <div className="text-center group">
              ...
              <div className="text-gray-400 font-inter">Total Ratings</div>
            </div>
            <div className="text-center group">
              ...
              <div className="text-gray-400 font-inter">Average Rating</div>
            </div>
          </div>
        </div>
      </div>
