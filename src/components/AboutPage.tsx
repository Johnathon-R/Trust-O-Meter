      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className={`group relative mb-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
            <h2 className="font-inter font-bold text-2xl text-white mb-4 flex items-center gap-2">
        ...
        <div className={`grid md:grid-cols-2 gap-6 mb-8 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="group relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <h3 className="font-inter font-semibold text-lg text-white mb-2">Complete Anonymity</h3>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <h3 className="font-inter font-semibold text-lg text-white mb-2">Immutable Records</h3>
              <p className="font-inter text-gray-300">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <h3 className="font-inter font-semibold text-lg text-white mb-2">Instant Verification</h3>
              <p className="font-inter text-gray-300">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <h3 className="font-inter font-semibold text-lg text-white mb-2">Real-time Analytics</h3>
              <p className="font-inter text-gray-300">
          ...
          <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 group/step hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-inter font-semibold text-white mb-1">Submit Your Rating</h3>
                  <p className="font-inter text-gray-300">Choose your rating and event type through our simple interface.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 group/step hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-inter font-semibold text-white mb-1">Connect Your Wallet</h3>
                  <p className="font-inter text-gray-300">Securely connect your Algorand wallet to sign the transaction.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 group/step hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-inter font-semibold text-white mb-1">Blockchain Recording</h3>
                  <p className="font-inter text-gray-300">Your rating is permanently recorded on the Algorand blockchain.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 group/step hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-inter font-semibold text-white mb-1">View Analytics</h3>
                  <p className="font-inter text-gray-300">Access real-time statistics and trends based on all submitted ratings.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 group/item hover:scale-105 transition-transform duration-300">
                ...
                <span className="font-inter text-gray-300">Instant transaction finality</span>
              </li>
              <li className="flex items-center space-x-3 group/item hover:scale-105 transition-transform duration-300">
                ...
                <span className="font-inter text-gray-300">Minimal transaction fees</span>
              </li>
              <li className="flex items-center space-x-3 group/item hover:scale-105 transition-transform duration-300">
                ...
                <span className="font-inter text-gray-300">Carbon-negative consensus mechanism</span>
              </li>
              <li className="flex items-center space-x-3 group/item hover:scale-105 transition-transform duration-300">
                ...
                <span className="font-inter text-gray-300">Proven security and decentralization</span>
              </li>
            </ul>
          </div>
        </div>
